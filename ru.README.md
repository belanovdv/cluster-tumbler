...
> **Частичная реализация.** Запись документа команды поддерживается. Обработчик на стороне лидера, читающий очередь, применяющий изменение desired state и архивирующий результат, не реализован.
